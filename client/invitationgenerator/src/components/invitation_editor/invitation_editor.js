        ...
        <>
            ...
            <div className='invitation_editor'>
                <div className="column">
                    {
                        background_image != "" ?
                            <Settings path_to_server={path_to_server} type="wedding" background_image={background_image} template_type={template_type} set_template_type={set_template_type} invitation_text={invitation_text} set_invitation_text={set_invitation_text} greetings_list={greetings_list} set_greetings_list={set_greetings_list} />
                            : null
                    }
                </div>
                <div className="column">
