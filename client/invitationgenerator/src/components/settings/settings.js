    ...
    return (
        ...
        <>         
            <div className="settings">
                <Text_Settings background_image={background_image} path_to_server={path_to_server} type={type} set_edit_template_regime={set_edit_template_regime} invitation_text={invitation_text} set_invitation_text={set_invitation_text} />
            </div>
            <div className="settings">
