...
function Settings(props) {
    ...
    function generating_invitation_text() {
        if (template_type != "Професійний") {
            ...
            buf_invitation_text.push({ text: [[{ body: greetings_list.length != 0 ? greetings_list[0] : "", type: "", placeholder: "(звернення до групи запрошених)", marginLeft: 0, permission: false }]], offset: 1 })
            ...
            buf_invitation_text.push({ text: [[{ body: greetings_list.length != 0 ? greetings_list[0] : "", type: "", placeholder: "(звернення до групи запрошених)", marginLeft: 0, permission: false }]], offset: 0 })
            buf_invitation_text.push({ text: [[{ body: "", type: "", placeholder: "_____", marginLeft: 0, permission: true }]], offset: 1 })
